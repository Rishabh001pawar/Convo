...
const PostCard = ({post}) => {
    ...
    const postWithHashtags = post.content.replace(/(#\w+)/g, '<span class="test-indigo-600">$1</span>')
  ...
  return (
    <div className='bg-white rounded-xl shadow p-4 space-y-4 w-full max-w-2xl'>
      {/* User Info */}
      <div onClick={()=> navigate(`/profile/${post.user._id}`)} className='inline-flex items-center gap-3 curso-pointer'>
