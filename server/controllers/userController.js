...
export const updateUserData = async (req, res) => {
    try {
        ...
        if(profile){ const buffer = fs.readFileSync(profile.path)
...
export const sendConnectionRequest = async (req, res) => {
    try {
        ...
        if(connectionRequests.length >= 30){
            return res.json({success: false, message: 'You have sent more than 30 connection requests in the last 24 hours'})
        }
